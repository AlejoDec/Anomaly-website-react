...
export default function Footer() {
    return (
        <footer className='flex flex-col w-screen gap-6'>
            <div className=' flex flex-col justify-evenly gap-6 h-[40vh]'>
            ...
            <div className='flex items-center justify-center p-8 gap-2 h-[30vh]'>
                <div className='px-[12em] flex flex-col flex-start'>
                    <img src="/anomaly-image/logoBlanco.png" alt="Logo blanco anomaly" className='w-[150px]' />
                    <p className='text-stone-300'>Anomaly</p>
                    <p className='text-stone-300 underline'>Itagüí - Antioquia - Colombia</p>
                </div>
                <div className='flex flex-col gap-4'>
                    <div className='flex items-center gap-8'>
                        <p className='text-stone-300 text-xl'>Nos encantaria trabajar con tigo:</p>
                        <CallToAction href='/contacto' text='Trabajemos juntos' className='text-stone-800 p-0.5 text-md font-normal hover:text-white'/>
